...
internal enum StoryboardScene {
  internal enum CriarConta: StoryboardType {
    internal static let storyboardName = "CriarConta"
  ...
  internal enum Main: StoryboardType {
    ...
    internal static let viewController = SceneType<cineApp.ViewController>(storyboard: Main.self, identifier: "ViewController")
  }
}
